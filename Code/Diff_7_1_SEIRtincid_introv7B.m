function dPop=Diff_7_1_SEIRtincid_introv7B(t,pop, n, beta_cityt, gamma, alpha, mu, l, r, c_ones, r_ones)

% difference between v7 and v7B is that infeceds move in v7B
...
dY = W.*(alpha*c_ones) - Y.*(gamma*c_ones) + l.*(r_ones*diaY') - r.*Y - Y.*(mu*c_ones);   % note change
