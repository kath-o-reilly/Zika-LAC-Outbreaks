 ...
 % use previous run as baseline for mcmc
%load('est_params_ABCv6R1_22Nov17.mat')
% 
% feature('DefaultCharacterSet','UTF8')
% % SECTION 1 - load in data
% % ironically - brazil data doesn't include incidence
% % /Users/kathleen/Dropbox (VERG)/Dropbox/Zika/ZikaData/Outputs
% season = readtable('/Users/kathleen/Dropbox (VERG)/Dropbox/Zika/ZikaData/Outputs/dat_cities_checked_R0_Nov17.csv','FileEncoding','UTF-8');
% gmat = readtable('/Users/kathleen/Dropbox (VERG)/Dropbox/Zika/ZikaData/Outputs/distmat_Nov17.csv','FileEncoding','UTF-8');
% rmat  = readtable('/Users/kathleen/Dropbox (VERG)/Dropbox/Zika/ZikaData/Outputs/rad_matrix_24Nov17.csv','FileEncoding','UTF-8');
% fmatavg = readtable('/Users/kathleen/Dropbox (VERG)/Dropbox/Zika/ZikaData/Outputs/flights_avg_24Nov17.csv','FileEncoding','UTF-8');
% intro = readtable('/Users/kathleen/Dropbox (VERG)/Dropbox/Zika/ZikaData/Outputs/country_onset_2Oct2017.csv','FileEncoding','UTF-8');
% incid = readtable('/Users/kathleen/Dropbox (VERG)/Dropbox/Zika/ZikaData/Outputs/all_countries_incidence_18Feb18.csv','FileEncoding','UTF-8');  % I don't think this needed updating for GLP, etc
%  
...
% 
% % *** main compators - Xdat_epid & Xdat_peak_ever ***
% 
...
% %method = 'flight-rad';  % or 'grav-simple' 'grav-exp' or 'rad-simple' 'flight-simple'
% %params_exp = [ 2.2 0.1 0.9] ; %[Store(ii,3) Store(ii,4) Store(ii,5)];
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % ABC section - round 1
...
% tic
% 
% Iter = 500; % number of particles to set off for each model
% 
...
% 
% 
% mod_opts = ["grav-simple","grav-exp","rad-simple","flight-simple","flight-rad"]  % STRING (note double quotation marks)
...
% 
% Out_paramsI = zeros(Iter,5);
% Out_paramsP = zeros(Iter,5);
% 
